...
import com.rudolfpopin.shane.camerarecorderprototype.MainActivityFragment;
...
import com.rudolfpopin.shane.camerarecorderprototype.controller.previewController.PreviewController;
import com.rudolfpopin.shane.camerarecorderprototype.libs.squareRecorderLib.CONSTANTS;
import com.rudolfpopin.shane.camerarecorderprototype.libs.squareRecorderLib.NewFFmpegFrameRecorder;
import com.rudolfpopin.shane.camerarecorderprototype.libs.squareRecorderLib.ProgressView;
import com.rudolfpopin.shane.camerarecorderprototype.libs.squareRecorderLib.RecorderParameters;
import com.rudolfpopin.shane.camerarecorderprototype.libs.squareRecorderLib.SavedFrames;
import com.rudolfpopin.shane.camerarecorderprototype.libs.squareRecorderLib.Util;
 ...
 */
public class SquareRecorderController extends BaseController implements View.OnClickListener, View.OnTouchListener {
    ...
    private ImageButton switchCameraIcon;
                ...
                switch (msg.what) {
                    case 2:
                        ...
                        if(currentRecorderState == RecorderState.PRESS){
                            resId = R.string.pressToRecord;
                        }else if(currentRecorderState == RecorderState.LOOSEN){
                            resId = R.string.releaseToStopRecording;
                        }else if(currentRecorderState == RecorderState.CHANGE){
                            resId = R.string.changeViewToContinueRecording;
                        }else if(currentRecorderState == RecorderState.SUCCESS){
                            resId = R.string.finishRecording;
                        }
                        stateTextView.setText(resId);
                        break;
                    case 3:
                        if(!recording)
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_square_recorder, container, false);
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mainActivity.setOnDispatchTouchEventListener(new MainActivity.DispatchTouchEventListener() {
            @Override
    ...
    {
        stateTextView = (TextView) getView().findViewById(R.id.recorder_surface_state);
        progressView = (ProgressView) getView().findViewById(R.id.recorder_progress);
        progressView.setTotalTime(RECORDING_TIME);
        nextBtn = (Button) getView().findViewById(R.id.recorder_next);
        nextBtn.setOnClickListener(this);
        //txtTimer = (TextView)findViewById(R.id.txtTimer);
        flashIcon = (ImageButton)getView().findViewById(R.id.recorder_flashlight);
        switchCameraIcon = (ImageButton)getView().findViewById(R.id.recorder_frontcamera);
    ...
    private void initCameraLayout() {
        new AsyncTask<String, Integer, Boolean>(){
            ...
            protected void onPostExecute(Boolean result) {
                ...
                topLayout.setOnTouchListener(SquareRecorderController.this);

                switchCameraIcon.setOnClickListener(SquareRecorderController.this);
    ...
    public class AsyncStopRecording extends AsyncTask<Void,Integer,Void>{
        ...
        private void getFirstCapture(byte[] data){
            ...
            String captureBitmapPath = Util.createImagePath(getActivity());
...
//    }
    ...
    private void returnToCaller(boolean valid) {
        getActivity().getSupportFragmentManager().beginTransaction().add(getId(), PreviewController.create(strVideoPath), null).commit();
    }
